...
dtree = DecisionTreeClassifier(criterion="gini", max_depth=6, random_state=21)
dtree.fit(xTrainStd, yTrain)

yPred = dtree.predict(xTestStd)
...
plotDecisionRegions(X=xCombinedStd, y=yCombined, classifier=dtree, testIdx=range(105, 150))
